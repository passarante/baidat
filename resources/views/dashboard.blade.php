        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <small class="mt-10 text-small d-block">6% higher than last month</small>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <small class="mt-10 text-small d-block">61% higher than last month</small>
                        </div>
                        <div class="progress progress-sm">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <small class="mt-10 text-small d-block">Total Events</small>
                        </div>
                        <div class="progress progress-sm">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <small class="mt-10 text-small d-block">Total Comments</small>
                        </div>
                        <div class="progress progress-sm">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="row mb-15">
                                        ...
                                        <div class="text-right col-3">28%</div>
                                        <div class="col-12">
                                            <div class="mt-5 progress progress-sm">
                                    ...
                                    <div class="row mb-15">
                                        ...
                                        <div class="text-right col-3">21%</div>
                                        <div class="col-12">
                                            <div class="mt-5 progress progress-sm">
                                    ...
                                    <div class="row mb-15">
                                        ...
                                        <div class="text-right col-3">18%</div>
                                        <div class="col-12">
                                            <div class="mt-5 progress progress-sm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-right col-3">12%</div>
                                        <div class="col-12">
                                            <div class="mt-5 progress progress-sm">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <select class="ml-auto form-control w-25">
                                    <option selected="">Today</option>
                                    <option value="1">Weekly</option>
                                </select>
                            </div>
                            <div class="flex-row d-flex align-items-center mt-30">
                            ...
                            <hr>
                            <ul class="mt-20 mb-0 text-center list-unstyled row city-weather-days">
                                <li class="col"><i class="mr-5 wi wi-day-sunny"></i><span>09:30</span>
                                    <h3>20<sup>°</sup></h3>
                                </li>
                                <li class="col"><i class="mr-5 wi wi-day-cloudy"></i><span>11:30</span>
                                    <h3>22<sup>°</sup></h3>
                                </li>
                                <li class="col"><i class="mr-5 wi wi-day-hail"></i><span>13:30</span>
                                    <h3>25<sup>°</sup></h3>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="card">
                <div class="card-header row">
                    ...
                    <div class="col col-sm-3">
                        <div class="text-right card-options">
                        ...
                        <thead>
                            <tr>
                                <th class="nosort" width="10">
                                    <label class="m-0 custom-control custom-checkbox">
